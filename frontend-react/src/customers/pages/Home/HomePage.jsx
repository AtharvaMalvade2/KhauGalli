    ...
    <div className="">
      <section className="-z-50 banner relative flex flex-col justify-center items-center">
        <div className="w-[50vw] z-10 text-center">
          ...
          <p className="text-4xl lg:text-7xl font-extrabold text-white drop-shadow-lg">
            KhauGalli
          </p>
          {/* <p className="z-10   text-gray-300 text-xl lg:text-4xl">
            Taste the Convenience: Food, Fast and Delivered.
          </p> */}
          <p className="text-white text-lg lg:text-3xl italic font-sans">
            Savor the Flavor: Fresh, Fast, and Right at Your Doorstep.
          </p>
        </div>
