...
const Navbar = () => {
  ...
  return (
    <div className="px-5 z-50 py-[.8rem] bg-gray-900 lg:px-20 flex justify-between">
      ...
      <div className="flex items-center space-x-4">
        ...
        >
          <li className="text-cyan-500 text-2xl cursor-pointer">
            KhauGalli 🥙
          </li>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2 lg:space-x-10">
        ...
        <div className="flex items-center space-x-2">
          {auth.user?.fullName ? (
            ...
            >
              <Avatar sx={{ bgcolor: cyan[600], color: "white" }}>
